...
description: |
  Generate extended pseudocode for features in your Chatbot project following Clean Architecture patterns and your specific style. This skill analyzes the project graph, understands dependencies, and generates detailed pseudocode with XML/JSDoc structure suggestions, WHY comments, and mentor notes for learning. Use when implementing features, use cases, repositories, entities, or any component — it ensures consistency with your architecture, reduces token usage by providing structured pseudocode instead of scattered analysis, and accelerates implementation by giving you a complete technical blueprint ready to code. Include it whenever you need pseudocode for a sprint, component design, or architectural decision.
---

# Graphify Pseudocode Generator

Generate detailed, educational pseudocode for your Chatbot project that follows your exact style and Clean Architecture patterns.
...
Context/Layer: [Application.UseCases | Domain.Entities | Infrastructure.Repositories | WebApi.Endpoints]
...
Learning focus: Atomic transactions + Result pattern + IAnthropicService integration
Dependencies: IConversationRepository, IMessageRepository, IAnthropicService, Conversation, Message
Additional context: Should handle Claude integration without hardcoding, error handling for network failures, explain why SaveChangesAsync happens once at the end
```
...
- **WebApi Layer**: HTTP contracts (endpoints, filters, middleware)
