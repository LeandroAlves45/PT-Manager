...
description: |
  Generate extended pseudocode for features in PT Manager following layered architecture (routes → services → repositories → models). Generates detailed pseudocode with docstring/JSDoc suggestions, WHY comments, and mentor notes for learning. Use when implementing features, services, repositories, models, or API routes.
---

# Graphify Pseudocode Generator

Generate detailed, educational pseudocode for PT Manager (FastAPI + React SaaS multi-tenant).
