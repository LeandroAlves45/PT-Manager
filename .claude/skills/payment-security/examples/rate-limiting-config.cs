...
public static class RateLimitingExtensions
{
        ...
        IConfiguration config)
    {
        ...
        {
            // Policy 1: Payment Intent Creation (por trainer)
            options.AddPolicy("payment_creation", context =>
            ...
            // Policy 4: Refund Requests (por trainer)
            options.AddPolicy("refund_requests", context =>
                RateLimitPartition.GetFixedWindowLimiter(
                    partitionKey: context.User.GetTrainerId().ToString(),
                    factory: _ => new FixedWindowRateLimiterOptions
                    {
...
/// Controllers com rate limiting aplicado
...
public class PaymentIntentsController : ControllerBase
{
    ...
    [RateLimitPolicy("payment_creation")]
    ...
    public async Task<IActionResult> GetPaymentIntent(string id, CancellationToken ct)
    {
        return Ok();
    }
}
...
public class RefundsController : ControllerBase
{
    ...
    [RateLimitPolicy("refund_requests")]
...
/// Regras:
/// 1. payment_creation: 50/hora por trainer
/// 2. webhook_processing: 100/hora por IP
/// 3. refund_requests: 20/hora por trainer
