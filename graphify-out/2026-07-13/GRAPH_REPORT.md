# Graph Report - C:\Users\Leandro Alves\Desktop\Projeto pt_manager\Projeto_pt_manager  (2026-07-13)

## Corpus Check
- cluster-only mode — file stats not available

## Summary
- 2234 nodes · 4874 edges · 170 communities (124 shown, 46 thin omitted)
...
Cohesion: 0.06
Nodes (36): create_access_token(), Cria um token JWT com as claims necessárias para autenticação e controlo de aces, ActiveToken, SQLModel, Modelo para tokens de autenticação ativos.  Cada utilizador autenticado possui, Tokens de sessão ativos.      Segurança: Guarda HASH do JWT, não o JWT complet, Substitui token anterior e salva novo.         Usado em login e refresh -> reut, Autentica user e cria tokens.          Segurança:         - Rate limiting (fe (+28 more)
...
Cohesion: 0.09
Nodes (43): Food, MealPlan, MealPlanItem, MealPlanMeal, MealPlanMealSupplement, SQLModel, Modelos ORM para o sistem de Nutrição  Estrutura: foods - tabela principal de, Refeições dentro do plano alimentar (ex: pequeno-almoço, almoço, jantar, lanches (+35 more)

### Community 6 - "TestDefinePasswordAndAutoLogin"
Cohesion: 0.06
Nodes (26): Testes de integracao para o fluxo de convite de clientes (AU-09).  Cobre o flu, Trainer B não pode gerar convite para cliente de Trainer A., Falha no envio de email não deve bloquear a geração do link (best-effort)., Tentar gerar convite para cliente que ainda não tem conta User.         O train, Testes da validação pública de tokens de convite., Auxiliar: cria token de convite directamente na BD., GET /invite/validate/{token} com token valido devolve valid=True e nome., Token que não existe na BD deve devolver valid=False. (+18 more)

### Community 7 - "Exercises.jsx"
Cohesion: 0.14
Nodes (31): createPackType(), deletePackType(), getPackTypes(), updatePackType(), MUSCLE_GROUPS, MuscleMultiSelect(), getStatusStyle(), PlanList() (+23 more)

### Community 8 - "TrainingPlans.jsx"
Cohesion: 0.11
Nodes (25): getClients(), addExerciseToDay(), createPlanDay(), createTrainingPlan(), deleteDayExercise(), deletePlanDay(), deleteTrainingPlan(), getDayExercises() (+17 more)
...
Cohesion: 0.08
Nodes (29): activate_trainer(), get_metrics(), grant_exemption(), list_trainers(), Session, Router de administração - apenas superusers.  O superuser tem visibilidade glo, Revoga isenção de billing de um Personal Trainer,      obrigando-o a subscrever, Devolve métricas globais da plataforma para o superuser. (+21 more)

### Community 11 - "card.tsx"
Cohesion: 0.12
Nodes (24): getPlatformMetrics(), signupTrainer(), getMyMealPlans(), AlertsPanel(), ClientsAtRisk(), StatsCards(), WeeklyChart(), Card (+16 more)

### Community 12 - "client_portal.py"
Cohesion: 0.10
Nodes (35): _client_set_log_to_read(), _client_to_portal_profile_read(), _get_active_client_plan(), _get_client_id(), _get_client_or_404(), _get_day_exercise_for_active_plan_or_404(), get_my_check_ins(), get_my_meal_plans() (+27 more)

### Community 13 - "nutrition.py"
Cohesion: 0.08
Nodes (32): calculate_macros(), FoodCreate, FoodUpdate, FormulaResult, MacroCalculationRequest, MacroCalculationResponse, MacroDistribution, MacroTargets (+24 more)

### Community 14 - "TrainingSession"
Cohesion: 0.12
Nodes (25): cancel_session(), complete_session(), list_sessions(), mark_session_missed(), Session, Marca uma sessão como concluída e consome um pack do cliente., Agenda uma nova sessão de treino para um cliente específico., schedule_session_for_client() (+17 more)

### Community 15 - "button.tsx"
Cohesion: 0.23
Nodes (18): ClientFormDialog(), PHONE_PREFIXES, PackPurchaseDialog(), Button, ButtonProps, DialogContent, DialogDescription, DialogHeader() (+10 more)

### Community 16 - "hash_password"
Cohesion: 0.08
Nodes (23): hash_password(), Converte a password em hash usando bcrypt., Verifica se a password em texto plano corresponde ao hash armazenado., verify_password(), Session, seed_superuser(), client_user(), Trainer com subscricao activa. (+15 more)
...
Cohesion: 0.10
Nodes (23): SQLModel, Modelo para Refresh Tokens -> segurança da sessão., Tokens de refresh — permitem renovar access tokens sem pedir credenciais., Retorna True se não foi revogado e ainda não expirou., RefreshToken, datetime, Session, Repository para Refresh Tokens — segurança de sessão. (+15 more)

### Community 19 - "useAuth"
Cohesion: 0.17
Nodes (16): App(), Separator, applyBodyColor(), applyBrandColor(), AuthProvider(), AuthConsumer(), BrandTester(), BrandTesterSemHash() (+8 more)
...
Cohesion: 0.19
Nodes (24): archive_client(), _build_client_with_pack(), _client_status(), create_client(), delete_client(), get_client_details(), get_my_client_profile(), _get_trainer_id_filter() (+16 more)
...
Cohesion: 0.12
Nodes (24): Any, _handle_payment_failed(), _handle_payment_succeeded(), _handle_subscription_deleted(), _handle_subscription_updated(), _handle_trial_will_end(), _normalize_stripe_status(), Request (+16 more)

### Community 24 - "PlanDayExercise"
Cohesion: 0.26
Nodes (15): create_set_load(), delete_day_exercise(), delete_plan_day(), list_set_loads(), Converte set load com dados já carregados (evita queries extras).     Usa-se qu, Converte PlanExerciseSetLoad em schema de resposta.     Busca automaticamente o, _set_load_to_read(), _set_load_with_details_to_read() (+7 more)

### Community 25 - "MealsPlanPage.jsx"
Cohesion: 0.15
Nodes (21): archiveMealPlan(), createFood(), createMealPlan(), deleteFood(), getFoods(), getMealPlansByClient(), unarchiveMealPlan(), updateFood() (+13 more)
...
Cohesion: 0.15
Nodes (21): consume_session(), get_active_pack(), _get_owned_client(), list_client_packs(), purchase_pack_for_client(), Session, Rotas para gestão de packs de sessões do cliente.  Responsabilidades:   - Com, Lista packs comprados por um cliente. (+13 more)
...
Cohesion: 0.17
Nodes (15): addCheckinNotes(), createAssessment(), createCheckin(), getAssessmentsByClient(), getCheckinsByClient(), skipCheckin(), updateAssessment(), calculateMacros() (+7 more)

### Community 32 - "axiosConfig.js"
Cohesion: 0.12
Nodes (13): createUser(), applyBrandColor(), AuthContext, AuthProvider(), hexToHSL(), api, failedQueue, archiveClient() (+5 more)
...
Cohesion: 0.16
Nodes (23): getClient(), generateInvite(), cancelSession(), completeSession(), createSession(), getSessions(), markSessionMissed(), ClientTable() (+15 more)
...
Cohesion: 0.17
Nodes (20): _assert_food_owner(), create_food(), delete_food(), delete_meal_plan(), get_food(), get_meal_plan(), list_foods(), list_meal_plans_by_client() (+12 more)
...
Cohesion: 0.14
Nodes (20): activateTrainer(), archiveGlobalSupplement(), createGlobalExercise(), createGlobalFood(), createGlobalSupplement(), deleteGlobalExercise(), deleteGlobalFood(), deleteGlobalSupplement() (+12 more)
...
Cohesion: 0.29
Nodes (15): getGlobalExercises(), getGlobalFoods(), AlertDialogAction, AlertDialogCancel, AlertDialogContent, AlertDialogDescription, AlertDialogFooter(), AlertDialogHeader() (+7 more)

### Community 43 - "ClientLayout.jsx"
Cohesion: 0.12
Nodes (24): getPortalBranding(), bottomNavItems, isItemActive(), NavContent(), navItems, Sidebar(), Avatar, AvatarFallback (+16 more)
...
Cohesion: 0.11
Nodes (12): Serviço de integração com o Stripe.  Este módulo é a única camada da aplicação, Actualiza o tier de uma subscrição (ex: FREE → STARTER quando passa de 5 cliente, Cancela uma subscrição.          O Stripe mantém a subscrição activa até ao fi, Cria uma sessão para o portal de billing do Stripe.          O portal de billi, Verifica a assinatura do webhook e constrói o evento do Stripe.          Retor, Wrapper em torno da API do Stripe., Cria um Customer no Stripe para o trainer.          O Customer é criado no mom, Cria uma subscrição em modo trial para o trainer.          Durante o trial: (+4 more)
...
Cohesion: 0.18
Nodes (15): changeMyPassword(), getMyProfile(), getMyTrainingPlan(), respondToCheckIn(), upsertExerciseSetLogs(), formatProfileValue(), formatSexLabel(), formatTrainingModality() (+7 more)
...
Cohesion: 0.18
Nodes (17): create_pack_type(), delete_pack_type(), _get_owned_pack_type(), list_pack_types(), _pack_type_visibility_filter(), Session, Rotas para gestão de tipos de packs (catálogo de packs disponíveis).  Responsa, Cria um novo tipo de pack com validação de nome único. (+9 more)

### Community 50 - "client.py"
Cohesion: 0.13
Nodes (14): ActivePackInfo, ClientCreate, ClientRead, ClientUpdate, BaseModel, SQLModel, Schemas Pydantic para criação, atualização e leitura de clientes., Payload para criação de um novo cliente.     aqui validamos formato; regras de (+6 more)
...
Cohesion: 0.20
Nodes (15): create_assessment(), get_assessment(), list_assessments_by_client(), Session, Router de avaliações iniciais — InitialAssessment.   Estes endpoints gerem o f, update_assessment(), HealthQuestionnaire, InitialAssessmentCreate (+7 more)
...
Cohesion: 0.18
Nodes (15): InitialAssessment, SQLModel, Avaliação inicial do cliente — formulário de saúde completo.  Preenchido pelo, count_initial_assessments_by_client(), create_initial_assessment(), get_initial_assessment_by_id(), list_initial_assessments_by_client(), Session (+7 more)

### Community 57 - ".generate_invite"
Cohesion: 0.18
Nodes (12): _get_frontend_base_url(), InviteService, Session, Serviço de negócio para o fluxo de convite de clientes., Valida token de convite.          Retorna:             {                 "va, Cliente define password via token de convite.          Fluxo:         1. Vali, Calcula SHA-256 hash de um token., Envia email de convite (best-effort).         Falha no email NÃO bloqueia a cri (+4 more)

### Community 58 - "billing.py"
Cohesion: 0.23
Nodes (15): create_billing_portal(), create_checkout_session(), _ensure_stripe_customer_and_subscription(), get_subscription(), _persist_stripe_ids(), Request, Session, Router de billing — dashboard de subscrição do trainer.  Endpoints:     GET (+7 more)
...
Cohesion: 0.19
Nodes (13): NotificationChannel, NotificationStatus, Enum, str, Canais suportados para envio., Tipo de destinatário., Estados do ciclo de vida da notificação., RecipientType (+5 more)

### Community 61 - "TrainerSubscription"
Cohesion: 0.17
Nodes (13): SQLModel, Modelo de subscrição do trainer.  Cada trainer tem exactamente uma linha nesta, Estados possíveis de uma subscrição de trainer., Tiers de preço com base no número de clientes ativos., Modelo de subscrição do trainer.      Relação 1:1 com User (role="trainer")., SubscriptionStatus, SubscriptionTier, TrainerSubscription (+5 more)

### Community 62 - "EmailService"
Cohesion: 0.16
Nodes (8): EmailService, Service para enviar emails via Resend., Retorna HTML da logo (placeholder).          Pode ser customizado com logo_url, Envio de emails via Resend (noreply@ptmanageronline.pt)., Envia email plain text sem template (para notificações simples).          Args, Renderiza template Jinja2 com context., Envia email de verificação para trainer (P0.1).          Args:             tr, Envia email de convite para client.          Args:             client_email:
...
Cohesion: 0.15
Nodes (14): get_current_user(), Session, Módulo de segurança — autenticação, autorização e guards de acesso.  Camadas d, Valida o JWT Bearer e devolve o utilizador autenticado da base de dados., Garante que o utilizador autenticado é um superuser., Garante Personal Trainer ou superuser (sem verificar subscricao)., Personal Trainer com subscrição activa, superuser, ou isento de billing., Valida a API Key enviada no header X-API-Key. (+6 more)

### Community 65 - ".log_error"
Cohesion: 0.21
Nodes (11): ErrorCategory, ErrorLog, ErrorTracker, BaseModel, Enum, Exception, str, Centraliza logging estruturado de erros para debug. (+3 more)
...
Cohesion: 0.27
Nodes (7): archiveSupplement(), createSupplement(), deleteSupplement(), getSupplements(), unarchiveSupplement(), updateSupplement(), SupplementsPage()

### Community 68 - "Exercise"
Cohesion: 0.20
Nodes (20): _assert_owner(), create_exercise(), delete_exercise(), list_exercises(), Session, Router de exercícios — catálogo global + privado por trainer.   Regras de negó, Verifica se o exercício pertence ao trainer autenticado.     Levanta 403 se não, _to_read() (+12 more)
...
Cohesion: 0.21
Nodes (8): ActiveTokenRepository, datetime, Session, Repositorio para Active Tokens com hash seguro., Abstrai operações com Active Tokens. Guarda HASH e não token completo., Busca token ativo do user., Busca token específico pelo hash (validação segura)., Revoga token do user(logout).
...
Cohesion: 0.18
Nodes (11): autoprefixer, eslint, devDependencies, autoprefixer, eslint, postcss, @types/react-dom, vite (+3 more)
...
Cohesion: 0.33
Nodes (8): createBillingPortal(), createCheckout(), getSubscription(), Progress, BillingPage(), daysUntil(), getStatusLabel(), getStatusVariant()

### Community 78 - "App.jsx"
Cohesion: 0.21
Nodes (8): getMyCheckIns(), getDashboardForRole(), ProtectedRoute(), mockUseAuth, TrainerLayout(), ClientDashboard(), getStatusBadge(), MyCheckIns()

### Community 79 - "lifespan"
Cohesion: 0.20
Nodes (8): init_db(), Inicialização da base de dados.  Responsabilidades:     1. Importar todos os, Cria as tabelas na BD caso não existam     Em produto, isto é substituido por m, Session, Seed idempotente:     - Garante PackTypes 2/4/6/8 aulas     - Atualiza nome/is, seed_pack_types(), lifespan(), Startup hooks:     - Inicializa a base de dados     - Executa as migrations
...
Cohesion: 0.22
Nodes (9): dispatch_client_email(), Scheduler de notificacoes — APScheduler em background.  Dois jobs:   1. dispa, Exclui as linhas expiradas de active_tokens.      Esta é uma limpeza adicional, Inicia o scheduler APScheduler em background.      Chamado no hook on_startup, Desliga o scheduler graciosamente.      Chamado no hook on_shutdown do FastAPI, Envia email HTML para o cliente.      Lê os dados de template_data (JSONB) em, shutdown_scheduler(), start_scheduler() (+1 more)
...
Cohesion: 0.28
Nodes (18): clone_template_to_client(), create_plan(), create_plan_day(), day_to_read(), delete_plan(), delete_set_load(), list_plan_days(), list_plans() (+10 more)
...
Cohesion: 0.25
Nodes (8): MacroAdherence, MacroSummary, Resumo de macros calculado via query agregada.     Não corresponde a nenhuma ta, Comparação entre macros reais (alimentos do plano) e targets do PT.     Ajuda o, _build_adherence(), Agrega uma lista de macros (dicts ou MacroSummary) num único MacroSummary., Constrói o resumo de adherence (real vs target).     Retorna None se o plano nã, _sum_macros()

### Community 89 - "pack_types.py"
Cohesion: 0.36
Nodes (7): PackTypeCreate, PackTypeRead, PackTypeUpdate, SQLModel, Resposta pública de um tipo de pack., Payload para atualizar parcialmente um tipo de pack., Payload para criar um tipo de pack.

### Community 90 - "SubscriptionRead"
Cohesion: 0.32
Nodes (7): BaseModel, Resposta após registo de um novo trainer., Esquema para leitura da subscrição do trainer.     Inclui informações relevante, Esquema para registo de um novo trainer., SubscriptionRead, TrainerSignupIn, TrainerSignupOut
...
Cohesion: 0.47
Nodes (5): ClientPackPurchase, ClientPackRead, SQLModel, Resposta pública de um pack comprado por um cliente., Payload para comprar um pack para um cliente.
...
Cohesion: 0.40
Nodes (3): Session, Cancela todas as notificações PENDING de uma sessão.           Chamado quando, Devolve notificações PENDING cujo scheduled_for já passou.         Chamado pelo
...
Cohesion: 0.50
Nodes (3): _get_upgrade_message(), Servico de subscricoes � logica de negocio de tiers e controlo de acesso.  Est, Retorna mensagem de sugestao de upgrade com base no tier actual.

## Knowledge Gaps
- **203 isolated node(s):** `pt-manager`, `name`, `private`, `version`, `type` (+198 more)
...
- **Why does `commit_or_rollback()` connect `commit_or_rollback` to `Supplement`, `User`, `timedelta`, `AdminService`, `client_portal.py`, `TrainerSettings`, `utc_now_datetime`, `PlanDayExercise`, `ClientPack`, `CheckInRead`, `FastAPI`, `nutrition.py`, `Notification`, `PackType`, `InitialAssessmentRead`, `utc_now`, `billing.py`, `Exercise`, `ClientRepository`, `ActiveTokenRepository`, `training_plans.py`, `SignupService`?**
  _High betweenness centrality (0.169) - this node is a cross-community bridge._
- **Why does `Client` connect `commit_or_rollback` to `Supplement`, `User`, `auth.py`, `timedelta`, `nutrition.py`, `ClientRepository`, `TestDefinePasswordAndAutoLogin`, `AdminService`, `client_portal.py`, `TrainingSession`, `training_plans.py`, `InitialAssessmentRead`, `utc_now`, `.generate_invite`, `ClientPack`, `CheckInRead`?**
