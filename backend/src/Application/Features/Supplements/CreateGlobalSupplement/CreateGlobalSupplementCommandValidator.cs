...
/// <summary>Valida um suplemento global antes da persistência auditada.</summary>
public sealed class CreateGlobalSupplementCommandValidator
    : AbstractValidator<CreateGlobalSupplementCommand>
{
    public CreateGlobalSupplementCommandValidator()
    {
