...
/// <summary>Valida a atualização de um suplemento privado.</summary>
public sealed class UpdateSupplementCommandValidator : AbstractValidator<UpdateSupplementCommand>
{
