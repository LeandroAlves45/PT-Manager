...
/// <summary>Valida identificador e campos do exercício global, incluindo o vídeo HTTPS.</summary>
public sealed class UpdateGlobalExerciseCommandValidator
    : AbstractValidator<UpdateGlobalExerciseCommand>
{
    public UpdateGlobalExerciseCommandValidator()
    {
    ...
    private static bool BeAnHttpsUrl(string? videoUrl) =>
