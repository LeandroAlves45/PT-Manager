...
/// <summary>Bloqueia um alimento privado através do store administrativo dedicado.</summary>
public sealed class BlockFoodHandler
{
    private readonly IValidator<BlockFoodCommand> _validator;
    private readonly ITenantContext _tenantContext;
    private readonly IClock _clock;
    private readonly IPrivateCatalogModerationStore _store;

    public BlockFoodHandler(
        IValidator<BlockFoodCommand> validator,
        ...
        CancellationToken cancellationToken)
    {
        ...
        var outcome = await _store.BlockFoodAsync(
            actor.Value.UserId,
            command.FoodId,
