...
/// <summary>Valida a solicitação de atualização de um tipo de pack privado.</summary>
public sealed class UpdatePackTypeCommandValidator : AbstractValidator<UpdatePackTypeCommand>
{
