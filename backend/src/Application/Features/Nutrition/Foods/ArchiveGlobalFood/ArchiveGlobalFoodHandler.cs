...
namespace Application.Features.Nutrition.Foods.ArchiveGlobalFood;

/// <summary>Arquiva um alimento global de forma auditada.</summary>
public sealed class ArchiveGlobalFoodHandler
{
    private readonly ITenantContext _tenantContext;
    private readonly IClock _clock;
    private readonly IGlobalFoodStore _store;

    public ArchiveGlobalFoodHandler(
    ...
    public async Task<Result> HandleAsync(
        ArchiveGlobalFoodCommand command,
