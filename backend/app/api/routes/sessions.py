...
async def complete_session(session_id: str, session: Session = Depends(get_session)) -> TrainingSession:
    """
...
async def cancel_session(session_id: str, session: Session = Depends(get_session)) -> TrainingSession:
