...
async def list_plan_days(plan_id: str, session: Session = Depends(get_session),) -> List[TrainingPlanDayRead]:
...
async def create_plan_day(plan_id: str, payload: TrainingPlanDayCreate, session: Session = Depends(get_session),) -> TrainingPlanDayRead:
...
async def update_plan_day(day_id: str, payload: TrainingPlanDayUpdate, session: Session = Depends(get_session)) -> TrainingPlanDayRead:
...
async def delete_plan_day(day_id: str, session: Session = Depends(get_session)) -> None:
...
async def list_day_exercises(day_id: str, session: Session = Depends(get_session),) -> List[PlanDayExerciseRead]:
...
async def create_day_exercise(day_id: str,payload: PlanDayExerciseCreate, session: Session = Depends(get_session),) -> PlanDayExerciseRead:
...
async def update_day_exercise(day_exercise_id: str, payload: PlanDayExerciseUpdate, session: Session = Depends(get_session)) -> PlanDayExerciseRead:
...
async def delete_day_exercise(day_exercise_id: str, session: Session = Depends(get_session)) -> None:
...
async def list_set_loads(day_exercise_id: str, session: Session = Depends(get_session),) -> List[PlanExerciseSetLoadRead]:
...
async def create_set_load(day_exercise_id: str,payload: PlanExerciseSetLoadCreate, session: Session = Depends(get_session),) -> PlanExerciseSetLoadRead:
...
async def update_set_load(set_load_id: str, payload: PlanExerciseSetLoadUpdate, session: Session = Depends(get_session)) -> PlanExerciseSetLoadRead:
...
async def delete_set_load(set_load_id: str, session: Session = Depends(get_session)) -> None:
...
async def get_active_plan(client_id: str, session: Session = Depends(get_session),) -> Optional[ClientActivePlanRead]:
...
async def set_active_plan(payload: ClientActivePlanCreate, session: Session = Depends(get_session)) -> ClientActivePlanRead:
...
async def close_active_plan(client_id: str, session: Session = Depends(get_session)) -> Optional[ClientActivePlanRead]:
...
async def clone_template_to_client(template_plan_id: str, payload: ClonePlanToClientCreate, session: Session = Depends(get_session)) -> TrainingPlanRead:
