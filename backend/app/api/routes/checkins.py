...
async def create_checkin(payload:CheckInCreate, session: Session = Depends(get_session), current_user=Depends(require_active_subscription)):
...
async def list_checkins_for_client(client_id: str, session: Session = Depends(get_session), current_user=Depends(require_active_subscription)):
...
async def get_my_pending_checkins(session: Session = Depends(get_session), current_user=Depends(get_current_user)):
...
async def respond_to_checkin(checkin_id: str, payload: CheckInResponse, session: Session = Depends(get_session), current_user=Depends(get_current_user)):
...
async def add_trainer_notes(checkin_id: str, payload: CheckInTrainerNotes, session: Session = Depends(get_session), current_user=Depends(require_active_subscription)):
...
async def skip_checkin(checkin_id: str, session: Session = Depends(get_session), current_user=Depends(require_active_subscription)):
