...
class ClientPack(SQLModel, table=True):
    """
    Pack comprado por um cliente.

    sessions_total_snapshot: snapshot do número total de sessões no pack_type na compra.
    Evita problemas se o pack_type for alterado depois da compra.

    sessions_used: contador consumido transacionalmente ao completar sessões.
    """
