"""
Modelo de base de dados para clientes.
"""
...
class Client(SQLModel, table=True):
    ...
    Nota:
    - UUID  é armazenado como string (PostgreSQL) para simplicidade
    ...
    next_assessment_date: Optional[date] = Field(default=None)

    owner_trainer_id: Optional[str] = Field(
